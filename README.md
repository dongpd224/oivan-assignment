...
- **6 Libraries**
@oivan/
  - `@oivan/feature-products` - Product listing feature (Angular)
  - `@oivan/feature-product-detail` - Product detail feature (Angular)
  - `@oivan/data` - Data access layer for shop features
  - `@oivan/shared-ui` - Shared UI components
  - `@oivan/models` - Shared data models
